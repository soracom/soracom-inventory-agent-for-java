 ...
 **/
@LWM2MObject(objectId = 13, name = "LWM2M Bearer Selection")
public abstract class LWM2MBearerSelectionObject extends AnnotatedLwM2mInstanceEnabler {
	...
	/**
	 * Provides guide to the application when performing manual network selection; the range is -48 to -110.
	 **/
	...
	/**
	 * Provides guide to the application when performing manual network selection; the range is -25 to -120.
	 **/
	...
	/**
	 * Provides guide to the application when performing manual network selection; the range is -44 to -140.
	 **/
	...
	/**
	 * Allows server to see results of network scan (e.g. result of AT+COPS=? as per 3GPP-TS_27.007)
	 **/
	...
	/**
	 * Provides guide to the application when performing manual network selection; the range is -44 to -158.
	 **/
