...
public abstract class APNConnectionProfileObject extends AnnotatedLwM2mInstanceEnabler {
	...
	/**
	 * Presented to network during connection to PDN e.g. ‘internet.15.234’. This
	 * resource is not included in case ‘Auto select APN by device’ resource has the
	 * value TRUE. If the APN resource is present but contains an empty string, then
	 * the device shall not provide an APN in the connection request (invoking
	 * default APN procedures in the network).
	 **/
	 ...
	 * Resource not included in case the ‘APN’ resource is specified.
	 **/
	...
	/**
	 * True: connection is activated False: connection is de-activated. Allows the
	 * profile to be remotely activated or deactivated.
	 **/
	...
	/**
	 * Enumerated type: 0: PAP 1: CHAP 2: PAP or CHAP 3: None
	 **/
	...
	/**
	 * For LTE and NB-IoT only QCI=Quality of service Class Identifier This resource
	 * enables the LWM2M server to signal the LWM2M client which QCI it shall
	 * request from the network. See [3GPP-TS_23.203, and 3GPP-TS_24.301] for a
	 * description of QCI values. See note (3).
	 **/
	 ...
	 * per APN. Rate Control information is part of the Protocol Configuration
	 * Options (PCO) according to [3GPP-TS_24.008 and 3GPP-TS_27.060]
	 **/
