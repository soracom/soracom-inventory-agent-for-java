...
public abstract class ConnectivityMonitoringObject extends AnnotatedLwM2mInstanceEnabler {
	...
	public abstract ReadResponse readNetworkBearer(ResourceContext resourceContext)	;
	...
	public abstract ReadResponse readAvailableNetworkBearer(ResourceContext resourceContext)	;
	...
	public abstract ReadResponse readRadioSignalStrength(ResourceContext resourceContext)	;
	...
	public abstract ReadResponse readIPAddresses(ResourceContext resourceContext)	;
