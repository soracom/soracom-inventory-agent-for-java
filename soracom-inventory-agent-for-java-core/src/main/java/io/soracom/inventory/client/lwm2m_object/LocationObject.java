...
public class LocationObject extends BaseInstanceEnabler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LocationObject.class);
    ...
    public LocationObject(Float latitude, Float longitude, float scaleFactor) {
        if (latitude != null) {
    ...
    public Float getLatitude() {
        return Float.valueOf(latitude - 90.0f);
    }

    public Float getLongitude() {
        return Float.valueOf(longitude - 180.f);
    }
