...
public class StringValueResolverTest {
	...
	private Object value = "hoge";
	private ValueResolver<String> resolver = new StringValueResolver();
	...
	public void testToReadResponse() {
		...
		ReadResponse readResponse = resolver.toReadResponse(rc, (String) value);
