...
public class TemplateClassGeneratorMain {
	...
	public static void main(String[] args) throws Exception {
		...
		String javaPackage = "io.soracom.inventory.agent.core.lwm2m.base_object";
		File outputDir = new File("src/main/java/" + javaPackage.replaceAll("\\.", "\\/"));
		for (ObjectModel model : rdfResource) {
			TemplateClassGenerator generator = new TemplateClassGenerator();
