...
public class BooleanValueResolverTest {

	private Type type = Type.BOOLEAN;
	private Object value = true;
	private ValueResolver<Boolean> resolver = new BooleanValueResolver();
	...
	public void testToReadResponse() {
		...
		ReadResponse readResponse = resolver.toReadResponse(rc, (Boolean) value);
